      ...
      <div>
        {this.props.network.downloadClient ? (
          ...
          !this.props.network.isMobileWeb3Wallet && (
            <WalletClientSelector formatClientName={formatClientName} />
          )
        ) : (
          <React.Fragment>
              ...
              <React.Fragment>
                {!this.state.sendToken && (
                  <h2 className="typo-h2 wallet">
                    ...
                    <span>{formatClientName(getCurrentProviderName())}</span>
                    <DropdownMenu icon={walletIcon}>
                      <MenuItems>
                        ...
                        {this.renderWalletOptions().map(key => (
                          <MenuItem
                            href="#action"
                            text={`Connect ${formatClientName(key)}`}
                            icon={menuIcons[key]}
                            key={key}
                            data-client={key}
                            onClick={this.switchConnection}
                      ...
                      <MenuFooter>
                        ...
                        <a href="#action" onClick={this.logOut}>
                          Log Out
                        </a>
                      </MenuFooter>
                    </DropdownMenu>

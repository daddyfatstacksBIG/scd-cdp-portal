                ...
                {this.props.history &&
                  ...
                  this.props.history.map((action, key) => {
                    ...
                    switch (action.act) {
                      case "OPEN":
                        message = (
                          <React.Fragment>Opened your CDP</React.Fragment>
                        );
                      ...
                      case "LOCK":
                        message = (
                          <React.Fragment>
                            Deposited{" "}
                            {printNumber(toWei(action.arg * action.per))} ETH (
                            {printNumber(toWei(action.arg))} PETH) to your CDP
                          </React.Fragment>
                        );
                      ...
                      case "FREE":
                        message = (
                          <React.Fragment>
                            Withdrew{" "}
                            {printNumber(toWei(action.arg * action.per))} ETH (
                            {printNumber(toWei(action.arg))} PETH) from your CDP
                          </React.Fragment>
                        );
                      ...
                      case "DRAW":
                        message = (
                          <React.Fragment>
                            Generated {printNumber(toWei(action.arg))} SAI from
                            your CDP
                          </React.Fragment>
                        );
                      ...
                      case "WIPE":
                        message = (
                          <React.Fragment>
                            Paid back {printNumber(toWei(action.arg))} SAI to
                            your CDP
                          </React.Fragment>
                        );
                      ...
                      case "SHUT":
                        message = (
                          <React.Fragment>Closed your CDP</React.Fragment>
                        );
                        image = historyIconUnknown;
                        break;
                      case "BITE":
              ...
              >
                ...
                <div className="history-details">
                  <span onClick={() => this.toggleExpand()}>
                    {this.state.stepsExpanded ? "Collapse" : "Expand"} complete
                    history
                  </span>
                </div>
              </div>

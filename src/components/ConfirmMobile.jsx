      ...
      <div id="confirmMobile">
        <div className="row">
          <div className="col">
            <div>
              <h3
                className="typo-cl inline-headline"
                style={{ color: "#ffffff" }}
              >
                Collateral at risk
              </h3>
        ...
        <div className="row" style={{ marginTop: "10px" }}>
          <div className="col">
            ...
            <div
              className={
                "typo-cm wizard-automated-transactions" +
            ...
            >
              ...
              >
                There are {this.steps().length} steps needed to complete the
                creation of your CDP.&nbsp;&nbsp; These will be automated for
                your convenience.
              </div>
          ...
          >
            <p style={{ color: "#B42B00", fontWeight: 500, fontSize: "13px" }}>
              When you open a CDP, the Stability Fee might vary due to changing
              market conditions.&nbsp;
              <a
            ...
            <div className="col">
              <div style={{ marginBottom: "2rem" }}>
                ...
                >
                  ...
                  />
                  <span className="checkmark"></span>I have read and accept the{" "}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    mixpanel.track("btn-click", {
                      id: "confirmCDP",
                      mobile: true,
                      collateral: formatAmount(eth),
                      debt: formatAmount(dai),
